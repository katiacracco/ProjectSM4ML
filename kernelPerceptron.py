...
# statistics to use for results
class Results():
    def __init__(self, predsAvg, predSmallErr):
        self.predsAvg = np.zeros()
    ...
    def train(self, xTrain, yTrain, kernelTrain):
        ...
        for epoch in range(1,self.epochNumber+1): # given number of epochs
            ...
            if epoch%5 == 0:
                ...
                self.statistics[1,int(epoch/5-1)] = round(np.argmin(error),2) # ma ha senso come valore?
